...
public class ImagenFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonIrAActividadAdicional = (Button) view.findViewById(R.id.buttonIrAActividadAdicional);
        buttonIrAActividadAdicional.setOnClickListener(new View.OnClickListener() {
            @Override
